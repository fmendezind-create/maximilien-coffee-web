...
export function Nav({ breadcrumb }: NavProps) {
  ...
  return (
    <>
      <nav className="sticky top-0 z-[200] bg-white-warm/98 backdrop-blur-[12px] border-b border-cream-3/60 shadow-[0_1px_0_rgba(200,168,74,0.08)]">
        <div className="flex items-center justify-between px-5 md:px-12 h-16 max-w-[1360px] mx-auto">
          ...
          <Link href="/" className="flex items-center gap-2.5 no-underline shrink-0" aria-label="Maximilien Coffee">
            ...
            <div>
              <div className="font-display text-[14px] font-bold tracking-[0.25em] text-ink uppercase">Maximilien Coffee</div>
