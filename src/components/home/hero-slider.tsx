...
const SLIDES = [
  {
    image: "/images/Z_Carrusel_1.webp",
    eyebrow: "Origen exclusivo · Huila, Colombia",
    title: "El alma del café",
    titleEm: "colombiano",
    subtitle: "en cada taza",
    cta: { label: "Comprar ahora", href: "/cafes" },
    ctaSecondary: { label: "Conocer el origen", href: "/origen" },
    accent: "#C8A84A",
  },
  {
    image: "/images/Bourbon_1.webp",
    eyebrow: "Bourbon Rosado · 92 pts SCA · Natural",
    title: "El más premiado",
    titleEm: "del Huila",
    subtitle: "Frutos amarillos, jazmín, cacao fino",
    cta: { label: "Comprar ahora", href: "/cafes/bourbon-rosado" },
    ctaSecondary: { label: "Ver toda la colección", href: "/cafes" },
    accent: "#C8A84A",
  },
  {
    image: "/images/Colombia_1.webp",
    eyebrow: "Variedad Colombia · 87 pts SCA · Natural",
    title: "Equilibrado,",
    titleEm: "versátil",
    subtitle: "Cítrico, durazno, chocolate blanco",
  ...
  },
  {
    ...
    eyebrow: "Blend · 82 pts SCA · Lavado",
    title: "El favorito",
    titleEm: "de siempre",
    subtitle: "Caramelo, avellana, chocolate",
