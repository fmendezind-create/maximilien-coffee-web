// ──────────────────────────────────────────────────────────
// Modelo de productos — fuente única de verdad del catálogo.
// En producción esto se reemplaza por llamadas a la API
// (FastAPI + PostgreSQL), pero la forma de los tipos se
// mantiene igual para no romper los componentes.
// ──────────────────────────────────────────────────────────

export type Accent = "bourbon" | "colombia" | "blend";

export interface Variant {
  weight: string; // "250g" | "454g" | "500g"
...
export interface Product {
  slug: string;
  accent: Accent;
  badge: string; // "La joya" | "Sofisticado" | "El favorito"
  kicker: string; // "Bolsa dorada" | "Bolsa negra" | "Bolsa roja"
  name: string;
  variety: string;
...
export const PRODUCTS: Product[] = [
  {
    ...
    reviewCount: 48,
    rating: 5,
    image: "/images/bourbon-main.svg",
    gallery: ["/images/bourbon-1.svg", "/images/bourbon-2.svg", "/images/bourbon-3.svg"],
  ...
  },
  {
    ...
    gallery: ["/images/colombia-1.svg", "/images/colombia-2.svg", "/images/colombia-3.svg"],
    storyTitle: "Por qué es especial",
    storyBody:
      "La Variedad Colombia fue desarrollada por Cenicafé como una alternativa resistente a la roya que mantiene la calidad de taza del Caturra. Lo que pocos saben es que, bien cultivada a gran altitud y procesada en honey, produce tazas extraordinarias — ácidas, jugosas y complejas. Este lote a 1.900 m.s.n.m. en el Huila lo demuestra con 89 puntos SCA.",
    processTitle: "Proceso honey",
    processBody:
      "En el proceso honey se retira la pulpa de la cereza pero se deja parte del mucílago adherido al grano durante el secado. Esa capa dulce fermenta suavemente, aportando notas de miel, fruta y caramelo que el proceso lavado no puede lograr. El resultado es una taza con más cuerpo y dulzura que un washed, pero más limpia que un natural.",
  },
  {
    slug: "blend",
    accent: "blend",
    ...
    gallery: ["/images/blend-1.svg", "/images/blend-2.svg", "/images/blend-3.svg"],
    storyTitle: "Por qué un blend",
    storyBody:
      "El Blend nació para quienes quieren un café de especialidad equilibrado y consistente todos los días. Combinamos Castillo, Caturra y Papayo — tres variedades del Huila — en proporciones que se ajustan cada cosecha para mantener el perfil de caramelo, avellana y chocolate que lo define. Es el café que nunca falla.",
    processTitle: "Proceso lavado",
    processBody:
      "En el proceso lavado se retira toda la pulpa y el mucílago antes del secado. El resultado es una taza más limpia, con acidez definida y donde el carácter de la variedad y el terruño se expresan con mayor claridad. Es el proceso clásico colombiano — y el que mejor funciona para el perfil chocolatoso del Blend.",
  },
];
